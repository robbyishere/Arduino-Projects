//Avoid Table Edge using IR Sensors
...
{
maneuver(200, -200, 750); // Right for 750 ms
}
else // Drop-off straight ahead
{
maneuver(-75, -250, 250); // Backward 250 ms before retry
}
}
...
void maneuver(int speedLeft, int speedRight, int msTime) // speedLeft, speedRight ranges: Backward Linear Stop Linear Forward -200 -100....0....100 200
{
